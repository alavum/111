...
const allNewsItems: NewsItem[] = [
  {
    ...
    excerpt: "Торжественное мероприятие в честь 79-й годовщины П��беды в Великой Отечественной войне.",
              ...
              {featuredNews.map((item, index) => (
                ...
                >
                  ...
                  <div className={`p-6 ${index === 0 ? 'md:p-8' : ''}`}>
                    ...
                    <h2 className={`font-bold text-gaming-text mb-3 group-hover:text-gaming-accent transition-colors ${
